...
# Global Framework Custom Error Handler
@bot.event
async def on_command_error(ctx, error):
    if isinstance(error, commands.MissingRequiredArgument):
        ...
        pass  # Quietly drop unrecognized command prefix spams
    else:
        # Prints any strange errors directly to your Railway terminal dashboard
