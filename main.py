# 1. Install the libraries and the Colab fix tool automatically
import os
os.system('pip install discord.py nest_asyncio')
...
# 2. Activate the fix so Colab doesn't throw that error
nest_asyncio.apply()
...
# Start the bot safely inside Colab
bot.run('MTUwNzM1OTg4NjQxMTk2MDQyMQ.GpR5r5.04t1DCfPAp97cWn7cmS0QQGFuABl2jp40Mejh4')
